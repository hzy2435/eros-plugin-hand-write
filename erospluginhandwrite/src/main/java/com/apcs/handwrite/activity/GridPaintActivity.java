package com.apcs.handwrite.activity;
...
import com.apcs.handwrite.R;
import com.apcs.handwrite.config.PenConfig;
import com.apcs.handwrite.util.BitmapUtil;
import com.apcs.handwrite.util.DisplayUtil;
import com.apcs.handwrite.util.SystemUtil;
import com.apcs.handwrite.view.CircleImageView;
import com.apcs.handwrite.view.CircleView;
import com.apcs.handwrite.view.GridDrawable;
import com.apcs.handwrite.view.GridPaintView;
import com.apcs.handwrite.view.HVScrollView;
import com.apcs.handwrite.view.HandWriteEditView;
import com.apcs.handwrite.view.PaintSettingWindow;
...
public class GridPaintActivity extends BaseActivity implements View.OnClickListener, Handler.Callback {
    ...
    protected void initView() {
        ...
        mEditView.setLineHeight((float)DisplayUtil.dip2px(this, fontSize));
    ...
    private void save() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Bitmap bm = GridPaintActivity.this.getWriteBitmap(bgColor);
    ...
    private void showQuitTip() {
        ...
        builder.setTitle("提示")
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        GridPaintActivity.this.setResult(RESULT_CANCELED);
                        GridPaintActivity.this.finish();
                    }
                });
        builder.show();
    }

...
import com.apcs.handwrite.util.StatusBarCompat;
...
import com.apcs.handwrite.view.PaintView;
...
public class PaintActivity extends BaseActivity implements View.OnClickListener, PaintView.StepCallback {
    ...
    protected void initView() {
        ...
        mHandView = (ImageView) findViewById(R.id.btn_hand);
        mUndoView = (ImageView) findViewById(R.id.btn_undo);
        mRedoView = (ImageView) findViewById(R.id.btn_redo);
        mPenView = (ImageView) findViewById(R.id.btn_pen);
        mClearView = (ImageView) findViewById(R.id.btn_clear);
        mSettingView = (CircleView) findViewById(R.id.btn_setting);
        ...
        builder.setTitle("提示")
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        PaintActivity.this.setResult(RESULT_CANCELED);
